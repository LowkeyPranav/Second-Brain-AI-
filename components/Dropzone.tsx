  ...
  return (
    <div
      ...
      className={`relative group border-2 border-dashed rounded-xl p-10 transition-all duration-300 flex flex-col items-center justify-center text-center cursor-pointer
        ${isDragging ? 'border-[#26BAA4] bg-[#26BAA4]/5' : 'border-[#E5E2D9] hover:border-[#26BAA4] bg-white shadow-sm hover:shadow-md'}
    ...
    >
      ...
      <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 transition-all duration-300 ${isLoading ? 'bg-[#FDFCF8]' : 'bg-[#FDFCF8] group-hover:bg-[#26BAA4]/10'}`}>
        {isLoading ? (
      ...
      <h3 className="text-lg font-bold text-[#2D2D2D] mb-1">
        {isLoading ? 'Processing Knowledge...' : 'Upload Your Notes'}
      </h3>
      <p className="text-[#666] text-sm max-w-xs font-medium">
