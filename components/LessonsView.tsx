  ...
  if (notes.length === 0 || !progress) {
    return (
      <div className="bg-white border border-[#E5E2D9] rounded-2xl p-16 text-center shadow-sm">
        <h2 className="text-2xl font-black text-[#2D2D2D] mb-4">Lesson Engine Paused</h2>
        <p className="text-[#666] max-w-sm mx-auto leading-relaxed">Strategic lessons require an analyzed repository. Upload your materials to generate adaptive study paths.</p>
      </div>
    );
  }
  ...
  if (loadingDrill) {
    return (
      <div className="bg-white border border-[#E5E2D9] rounded-2xl p-16 text-center shadow-sm flex flex-col items-center">
        ...
        <h3 className="text-xl font-black text-[#2D2D2D] mb-2">Synthesizing Adaptive Drill</h3>
        <p className="text-[#AAA] font-medium italic">Constructing concept-to-application pathways for "{drillTopic?.topic}"...</p>
      </div>
    );
  }
      ...
      <div className="space-y-8 animate-in slide-in-from-bottom-6 duration-500">
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <section className="bg-white border border-[#E5E2D9] rounded-2xl p-8 shadow-sm">
            <h3 className="text-xs font-black text-[#26BAA4] uppercase tracking-[0.2em] mb-6">1. Core Concept</h3>
          ...
          <section className="bg-white border border-[#E5E2D9] rounded-2xl p-8 shadow-sm border-l-8 border-l-[#26BAA4]">
            <h3 className="text-xs font-black text-[#26BAA4] uppercase tracking-[0.2em] mb-6">2. Annotated Example</h3>
            ...
            {!showExampleSolution ? (
              ...
              <div className="bg-[#FDFCF8] border border-[#E5E2D9] rounded-xl p-6 animate-in fade-in slide-in-from-top-4 duration-400">
                <h4 className="text-[10px] font-black text-[#26BAA4] uppercase tracking-widest mb-4">Step-by-Step Resolution</h4>
          ...
          <section className="bg-white border border-[#E5E2D9] rounded-2xl p-8 shadow-sm border-l-8 border-l-orange-400">
            <h3 className="text-xs font-black text-orange-400 uppercase tracking-[0.2em] mb-6">3. Solo Practice Challenge</h3>
            <div className="prose prose-stone max-w-none text-lg font-bold mb-8">
              <ReactMarkdown remarkPlugins={[remarkMath]} rehypePlugins={[rehypeKatex]}>
            ...
            {!showPracticeAnswer ? (
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-400">
                <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                  <h4 className="text-[10px] font-black text-green-600 uppercase tracking-widest mb-2">Final Verification</h4>
                ...
                <div className="bg-[#FDFCF8] border border-[#E5E2D9] rounded-xl p-6">
                  <h4 className="text-[10px] font-black text-[#666] uppercase tracking-widest mb-2">Pedagogical Feedback</h4>
                ...
                >
                  Conclude Lesson and Return to Plan
                </button>
              </div>
            )}
          </section>
    ...
    <div className="space-y-10 animate-in fade-in duration-700">
      <div className="bg-gradient-to-br from-[#2D2D2D] to-[#1A1A1A] text-white rounded-3xl p-10 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-black mb-4 tracking-tight">Adaptive Study Plan</h2>
          <p className="text-[#AAA] text-lg leading-relaxed max-w-xl font-medium">Neural engine has mapped <span className="text-[#26BAA4]">{weaknesses.length} critical bottlenecks</span> in your understanding. These drills are programmatically generated to accelerate your mastery via active recall.</p>
        </div>
      </div>

      <div className="space-y-4">
        <div className="flex items-center justify-between px-2">
          <h3 className="text-xs font-black text-[#26BAA4] uppercase tracking-[0.3em]">Prioritized Neural Drills</h3>
          <span className="text-[10px] font-bold text-[#AAA] bg-white border border-[#E5E2D9] px-3 py-1 rounded-full">{weaknesses.length} Topics Queued</span>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                <div className="hidden sm:flex flex-col items-end">
                  ...
                  <span className="text-xs font-bold text-[#666]">Guided Drill</span>
                </div>
          ...
          {weaknesses.length === 0 && (
            <div className="bg-[#26BAA4]/5 border-2 border-dashed border-[#26BAA4]/20 rounded-3xl p-20 text-center">
              ...
              <h3 className="text-2xl font-black text-[#2D2D2D] mb-2">Neural Balance Achieved</h3>
              <p className="text-[#666] font-medium">No critical weaknesses detected. Keep refining your repository to unlock deeper insights.</p>
            </div>
          )}
        </div>
      </div>
